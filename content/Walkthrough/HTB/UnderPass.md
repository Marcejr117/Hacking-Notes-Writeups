...
tenemos informacion interesante pero aun no es sufiente, ahora con [[SNMPWalk]] (la version que vamos a usar es la 1 ya que no tenemos credeciales para autenticarnos en la version 3)
```bash
